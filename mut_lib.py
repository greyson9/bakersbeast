...
aa_df['Total'] = aa_df.sum(axis=1)
# print(aa_df)
nofcods = np.array([4,2,2,2,2,4,2,3,2,6,1,2,4,2,6,6,4,4,4,1,2])
# print(aa_df['Total'].values)
# plt.scatter(nofcods,aa_df['Total'])
sb.regplot(x=nofcods,y=aa_df['Total'])
plt.show()
#print(aa_df)